        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Currency_PreferredCurrencyID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Product_Currency_BaseCurrencyID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Escrow", x => x.EscrowID);
                    table.ForeignKey(
                        name: "FK_Escrow_Order_OrderID",
                        column: x => x.OrderID,
                        principalTable: "Order",
                        principalColumn: "OrderID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemUnit_Product_ProductID",
                        column: x => x.ProductID,
                        principalTable: "Product",
                        principalColumn: "ProductID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceHistory_Currency_CurrencyID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingCartItem_AspNetUsers_BuyerID",
                        column: x => x.BuyerID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_PreferredCurrencyID",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Escrow_OrderID",
                table: "Escrow",
                column: "OrderID",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ItemUnit_ProductID",
                table: "ItemUnit",
                column: "ProductID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_BaseCurrencyID",
                table: "Product",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipping_ZoneID",
                table: "Shipping",
                column: "ZoneID");

            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartItem_BuyerID",
